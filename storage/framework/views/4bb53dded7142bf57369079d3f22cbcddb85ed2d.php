                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float-right">
                            <a href="<?php echo e(route('merchant.product.index')); ?>" class="btn btn-info">Back</a>
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                <form method="post" action="<?php echo e(route('merchant.product.store')); ?>" enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>

                                    <div class="form-group">
                                       <label for="inputStore" class="col-form-label">Store <span
                                                class="text-danger">*</span></label>
                                                <select class="form-control" name="tenant_id" id="store_id">
    ...
    <script>
        $(document).ready(function() {
            $(document).on("change", "#store_id", function () {
                ...
                $.ajax({
                url: "<?php echo e(URL::to('merchant/product-get-category')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp82\htdocs\bkshop\resources\views/backend/pages/product/create.blade.php ENDPATH**/ ?>