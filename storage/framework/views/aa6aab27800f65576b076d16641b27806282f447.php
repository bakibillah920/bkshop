                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                <form method="post" action="<?php echo e(route('merchant.store.store')); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputTitle" type="text" name="domain" placeholder="shop_one.root_route"
                                            value="<?php echo e(old('domain')); ?>" class="form-control">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp82\htdocs\bkshop\resources\views/backend/pages/store/create.blade.php ENDPATH**/ ?>